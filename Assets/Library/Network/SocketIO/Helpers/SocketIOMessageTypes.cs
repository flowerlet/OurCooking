...
namespace SocketIO
{
    ...
    {
        Disconnect = 0, //Signals disconnection. If no endpoint is specified, disconnects the entire SocketEntity.
        ...
        Event = 5, // An event is like a JSON message, but has mandatory name and Arguments fields.
